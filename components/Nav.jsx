  ...
  return (
    <nav className="bg-blue-900 text-gray-100 flex justify-between px-4 fixed	w-full top-0 z-20 ">
      ...
      <div className="m-auto mr-8  hidden    lg:block">
        <button
          className="relative z-10 lg:block p-2 text-white-700 bg-transparent text-white border:none border-transparent rounded-md dark:text-white focus:border-blue-500 focus:ring-opacity-40 dark:bg-gray-800 focus:outline-none"
        ...
        {show && (
          <div className="absolute right-8 z-20 w-48 py-2 mt-2 bg-white rounded-md shadow-xl dark:bg-gray-800 dropdown">
            <a
              href="#"
