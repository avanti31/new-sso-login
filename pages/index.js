        ...
        <div className="pb-4 w-1/2 border-b-4 border-red-400">
         ...
         <form onSubmit={handleSubmit(onSubmit)}>
            <div className="w-full mt-8">
             <input className={`${errors.employeeId ? "block w-full px-4 py-2 mt-2 text-base text-gray-700 placeholder-gray-500 bg-white border border-red-600 rounded-md focus:outline-none" : "block w-full px-4 py-2 mt-2 text-base text-gray-700 placeholder-gray-500 bg-white border rounded-md dark:placeholder-gray-400 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none"}`} placeholder="Username" name='employeeId' 
              {...register("employeeId", { required: true })} />
            </div>
            {errors.employeeId?.type === "required" && (
            <label
            className=" m-auto pt-2 text-red-600"
            >
              Provide valid username
            </label>
          )}
            <div className="w-full mt-6 mb-6">
              <input className={`${errors.password ? "block w-full px-4 py-2 mt-2 text-base text-gray-700 placeholder-gray-500 bg-white border border-red-600 rounded-md focus:outline-none" : "block w-full px-4 py-2 mt-2 text-base text-gray-700 placeholder-gray-500 bg-white border rounded-md dark:placeholder-gray-400 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none"}`} type="password" placeholder="Password" aria-label="Password"  name='password'
