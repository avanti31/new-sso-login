      ...
      <div className=" w-full py-8 w-50 flex grid lg:grid-cols-5  sm:grid-cols-2  md:grid-cols-3  gap-4">
        {portal && portal.map((item) => {
          ...
          <a
            ...
            key={`app-${item.appId}`}
            >
            <div className="mx-auto px-4 w-50 h-50 overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800" >
              <img className="m-auto object-contain" src={item.icon} alt="avatar" />
